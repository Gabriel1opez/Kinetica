const AVATARS = [
  { label: 'P1', color: '#ff3366' },
  { label: 'P2', color: '#ffd700' },
  { label: 'P3', color: '#39ff14' },
  { label: 'P4', color: '#00d4ff' },
  { label: 'P5', color: '#ff6b35' },
  { label: 'P6', color: '#cc88ff' },
  { label: 'P7', color: '#e91e8c' },
  { label: 'P8', color: '#00ffdd' },
];
